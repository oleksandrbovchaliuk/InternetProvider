...
namespace ElectronicShop.Controllers
{
    public class PositionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Position,Name_Of_Position")] Position position)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Position,Name_Of_Position")] Position position)
        {
            if (ModelState.IsValid)
            {
